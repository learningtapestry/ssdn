/**
 * event-parser.ts: Parses an API Gateway event as obtained from the lambda function and returns an
 * internal Nucleus event representation
 */

import get from "lodash/fp/get";
import {decode64, utcDate} from "../../app-helper";
    ...
    public parse() {
        ...
        return {
            ...
            event: {
                ...
                resourceId: get("resourceId")(this.request),
            },
        };
    }

    private interpretContent() {
        return get("isBase64Encoded")(this.lambdaEvent) ? decode64(this.body) : this.body;
    }
}
